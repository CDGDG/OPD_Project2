...
class Developer(models.Model):
    userid = models.CharField(max_length=20, verbose_name ='개발자 아이디', unique=True)
    password = models.CharField(max_length=500,verbose_name='개발자 비밀번호')
    nickname = models.CharField(max_length=15,verbose_name='닉네임')
    registnum = models.CharField(max_length=14,verbose_name = '주민번호')
    phonenum = models.CharField(max_length=20,verbose_name='핸드폰 번호')
    email = models.EmailField(max_length=128,verbose_name='이메일')
    regdate = models.DateTimeField(auto_now_add=True,verbose_name='등록일')
    pic = models.ImageField(upload_to='developer_pic/' , null=True)
